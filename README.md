...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/1yfnoRDVbS)
...
```sh
npx nx serve react-native-poc
```

To create a production bundle:

```sh
npx nx build react-native-poc
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-native-poc
```
